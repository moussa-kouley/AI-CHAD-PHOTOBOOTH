export const copy = {
  ...
  formatFilmHint: { en: "A moving portrait, plus a print.", fr: "Un portrait en mouvement, plus un cliché." },
  formatBothHint: { en: "Portraits and film.", fr: "Portraits et film." },
  ...
  scanKeep: { en: "Scan with your phone to save and share.", fr: "Scannez avec votre téléphone pour enregistrer et partager." },
