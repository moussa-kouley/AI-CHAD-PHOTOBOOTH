...
export const THEME_LOOK: Record<string, ThemeLook> = {
  ...
  Forum: { wash: "linear-gradient(165deg,#002664 0%,#1a7ad9 48%,#1a140c 100%)", note: "Gouvernance", cover: "/themes/forum.webp", motif: "horizon", hint: "FGI Tchad" },
  ...
  Ridge: { wash: "linear-gradient(165deg,#2a1008 0%,#c46a38 50%,#3a2010 100%)", note: "Horizon", cover: "/themes/ridge.webp", motif: "horizon", hint: "Éducation" },
  ...
  Stone: { wash: "linear-gradient(165deg,#2a1008 0%,#c46a38 50%,#3a2010 100%)", note: "Horizon", cover: "/themes/stone.webp", motif: "horizon", hint: "Cyber" },
  ...
  Clinic: { wash: "linear-gradient(165deg,#1a2428 0%,#d4e0dc 50%,#243038 100%)", note: "Atelier", cover: "/themes/clinic.webp", motif: "atelier", plate: false, hint: "Éducation" },
  ...
  Flight: { wash: "linear-gradient(165deg,#0a1018 0%,#4a6080 48%,#c8a25a 100%)", note: "Atelier", cover: "/themes/flight.webp", motif: "atelier", plate: false, hint: "Réseau" },
  Signal: { wash: "linear-gradient(165deg,#0c0c12 0%,#3a3a48 50%,#1a1816 100%)", note: "Atelier", cover: "/themes/signal.webp", motif: "atelier", plate: false, hint: "Cyber" },
